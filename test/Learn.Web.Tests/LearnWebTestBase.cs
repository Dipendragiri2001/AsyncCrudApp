...
{
    public abstract class LearnWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LearnWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LearnWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LearnDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LearnDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LearnDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LearnDbContext, Task<T>> func)
        {
            T result;
